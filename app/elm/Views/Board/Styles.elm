...
boardHeight model =
    round (model.tileSize.y * tileScaleFactor model.window) * model.boardDimensions.x


boardWidth : TileConfig model -> Int
boardWidth model =
    round (model.tileSize.x * tileScaleFactor model.window) * model.boardDimensions.y
